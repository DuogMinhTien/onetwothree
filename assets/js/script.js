...
function PlayNow() {
	if (styleChoose=="") {
		mynoti ("fail","Please choose a battle type","Choose your fighting style carefully, this is what determines your victory or defeat in this battle.");
	}
	else {
		...
		setTimeout ("$('#player').css('display','');$('#robot').css('display','')",250);
